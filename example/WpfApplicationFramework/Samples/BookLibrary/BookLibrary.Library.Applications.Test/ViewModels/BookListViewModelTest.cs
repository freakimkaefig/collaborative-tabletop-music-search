...
namespace Waf.BookLibrary.Library.Applications.Test.ViewModels
{
    ...
    public class BookListViewModelTest
    {
        ...
        public void BookListViewModelBooksTest()
        {
            ...
            BookListViewModel bookListViewModel = new BookListViewModel(bookListView, bookDataModels);
            ...
            bookListViewModel.SelectedBooks.Add(bookDataModels.First());
            Assert.IsTrue(bookListViewModel.SelectedBooks.SequenceEqual(new[] { bookDataModels.First() }));

            // Select both books
            bookListViewModel.SelectedBooks.Add(bookDataModels.Last());
        ...
        {
            MockBookListView bookListView = new MockBookListView();
            BookListViewModel bookListViewModel = new BookListViewModel(bookListView, new List<BookDataModel>());
